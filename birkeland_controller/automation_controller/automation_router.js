...
const { rebalance_lnd_channel, auto_rebalance_lnd_channels } = require("./reblance_controller");
...
apirouter.post("/auto_rebalance_lnd_channels",  auto_rebalance_lnd_channels);
